...
To download Original checkpoints, see the example command below leveraging `modelscope cli`:

```
modelscope download --model LLM-Research/Llama-3.2-1B-Instruct --include "original/*"  --local_dir Llama-3.2-1B-Instruct
```
